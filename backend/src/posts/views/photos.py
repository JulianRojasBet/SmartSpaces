...
from AI.dalle import modify_image as dalle
from AI.replicate import modify_image as replicate
from AI.image import modify as stablediffusion
    ...
    def suggestions(self, request, *args, **kwargs):
        ...
        if request.method == 'GET':
            ...
            if AI_model=='dalle':
                ...
                output = replicate(data['photo_url'], data['action'])

            elif AI_model=='stable_diffusion':
                output = stablediffusion(data['photo_url'], data['action'])
